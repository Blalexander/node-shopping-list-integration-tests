...
describe('Recipes', function() {
  ...
  it('should list recipes on GET', function() { //GET tests
  ...
  it('should add a recipe on POST', function() { //POST tests
    const newRecipe = {
  ...
  it('should update recipes on PUT', function() { //PUT tests
    const updateData = {
      name: 'foo',
  ...
  it('should delete recipes on DELETE', function() { //DELETE tests
    return chai.request(app)
      .get('/recipes')
      .then(function(res) {
        return chai.request(app)
